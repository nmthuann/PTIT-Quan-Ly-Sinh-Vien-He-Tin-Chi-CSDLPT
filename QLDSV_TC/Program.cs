...
namespace QLDSV_TC
{
    static class Program
    {
        ...
        public static String constr_publisher = "Data Source=MT-LAPTOP-ESHFI;Initial Catalog=QLDSV_TC;User ID=sa;Password=123456";
        ...
        public static forms.FormMain frmChinh;
        ...
        public static int KetNoi(Boolean isShow = true)
        {
            ...
            {
                if (isShow) MessageBox.Show("Vui lòng xem lại user name và password\n" + e.Message, "Lỗi đăng nhập", MessageBoxButtons.OK);
                return 0;
            }
        }
